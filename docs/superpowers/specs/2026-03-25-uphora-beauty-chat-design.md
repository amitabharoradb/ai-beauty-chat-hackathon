...
| LLM | Claude Sonnet 4.6 via Databricks Foundation Model API (`databricks-claude-sonnet-4-6`) — OpenAI-compatible, uses `DATABRICKS_TOKEN`, no separate API key needed |
